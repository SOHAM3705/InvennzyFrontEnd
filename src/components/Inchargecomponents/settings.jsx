...
const SettingsPage = () => {
  ...
  const fetchProfileData = async () => {
    ...
    try {
      ...
      const response = await axios.get("/api/settings/labincharge/profile", {
        headers: {
    ...
    const fetchNotificationSettings = async () => {
      try {
        ...
        const response = await axios.get(
          "/api/settings/labincharge/notifications",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "/api/settings/labincharge/password",
        {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      await axios.put("/api/settings/inchargesetting", requestData, {
        headers: {
